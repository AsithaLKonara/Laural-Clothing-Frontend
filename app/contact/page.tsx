      ...
      <div className="flex flex-col lg:flex-row w-full max-w-[1280px] min-h-[796px] mx-auto py-[80px] px-4 md:px-[120px] gap-16 lg:gap-0">
        ...
        <div className="flex flex-col flex-1 w-full lg:pr-[80px] lg:border-r lg:border-stone-200 gap-[40px]">
          ...
          <form className="flex flex-col gap-8 w-full">
            ...
            <div className="flex flex-col gap-3 w-full">
              <label className="font-poppins font-medium text-[13px] uppercase tracking-wider text-stone-500">
                Message <span className="text-[#C19A5B]">*</span>
              </label>
              <textarea 
                placeholder="How can we help you?"
                className="w-full h-[180px] p-[20px] border border-stone-200 rounded-[24px] bg-white font-poppins text-[15px] text-[#1C1917] outline-none focus:border-[#C19A5B] focus:ring-1 focus:ring-[#C19A5B] resize-none transition-all placeholder:text-stone-400"
              />
            </div>
            ...
            <button 
              type="button"
              className="w-full h-[54px] flex justify-center items-center bg-[#1C1917] hover:bg-stone-800 transition-colors rounded-full font-poppins font-semibold text-[14px] text-white uppercase tracking-widest mt-2"
            >
              Send Message
            </button>
          </form>
        ...
        <div className="flex flex-col w-full lg:w-[460px] lg:pl-[80px] gap-[30px] pt-[10px]">
          ...
          <div className="w-full aspect-[4/3] bg-stone-100 rounded-lg overflow-hidden relative shadow-sm border border-stone-200">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-stone-400 gap-3 bg-[url('https://www.transparenttextures.com/patterns/cartographer.png')] bg-stone-50">
              <div className="w-12 h-12 bg-white rounded-full shadow-sm flex items-center justify-center text-[#C19A5B]">
                <MapPin size={24} />
              </div>
              <span className="font-poppins text-[12px] uppercase tracking-widest font-medium text-stone-400">Map View</span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 mt-4">
            ...
            {/* Description */}
            <p className="font-poppins font-light text-[15px] leading-[1.8] text-stone-500 max-w-[340px]">
            ...
            <div className="flex flex-col gap-[20px] w-full mt-4">
              ...
              <div className="flex items-center gap-[16px] w-full group cursor-pointer">
                <div className="w-[40px] h-[40px] flex items-center justify-center border border-stone-200 bg-white group-hover:bg-[#1C1917] group-hover:border-[#1C1917] transition-colors rounded-full shrink-0 shadow-sm">
                  <MapPin size={16} strokeWidth={1.5} className="text-[#1C1917] group-hover:text-white transition-colors" />
                </div>
                <span className="font-poppins font-light text-[15px] text-[#1C1917]">
              ...
              <div className="flex items-center gap-[16px] w-full group cursor-pointer">
                <div className="w-[40px] h-[40px] flex items-center justify-center border border-stone-200 bg-white group-hover:bg-[#1C1917] group-hover:border-[#1C1917] transition-colors rounded-full shrink-0 shadow-sm">
                  <Phone size={16} strokeWidth={1.5} className="text-[#1C1917] group-hover:text-white transition-colors" />
                </div>
                <span className="font-poppins font-light text-[15px] text-[#1C1917]">
                  +94 76 112 8979
                </span>
              ...
              <div className="flex items-center gap-[16px] w-full group cursor-pointer">
                <div className="w-[40px] h-[40px] flex items-center justify-center border border-stone-200 bg-white group-hover:bg-[#1C1917] group-hover:border-[#1C1917] transition-colors rounded-full shrink-0 shadow-sm">
                  <Mail size={16} strokeWidth={1.5} className="text-[#1C1917] group-hover:text-white transition-colors" />
                </div>
                <span className="font-poppins font-light text-[15px] text-[#1C1917]">
