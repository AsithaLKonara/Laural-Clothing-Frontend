  ...
  return (
    <main className="relative flex flex-col w-full min-h-screen bg-[#FAFAF9] pt-[83px]">
      ...
      <div className="w-full bg-[#5E3122] py-20 px-4 flex flex-col items-center justify-center text-center relative overflow-hidden">
        ...
        <h1 className="font-poppins font-semibold text-[40px] md:text-[56px] text-[#FAFAF9] leading-tight mb-4 relative z-10 tracking-tight">
          End of Season Sale
        </h1>
        <p className="font-poppins text-[16px] md:text-[18px] text-[#FAFAF9]/90 max-w-[600px] relative z-10">
