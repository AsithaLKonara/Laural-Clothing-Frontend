    ...
    <main className="relative flex flex-col w-full min-h-screen bg-[#FAFAF9] pt-[83px]">
      ...
      <div className="relative w-full h-[400px] md:h-[500px] flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center px-4">
          <span className="font-urbanist font-medium text-[14px] text-white uppercase tracking-[0.3em] mb-4">
            Curated Collection
          </span>
          <h1 className="font-poppins font-semibold text-[40px] md:text-[56px] text-white leading-tight mb-4">
            {collectionName}
          </h1>
          <p className="font-poppins text-[16px] text-white/90 max-w-[600px]">
