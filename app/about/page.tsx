...
export default function AboutPage() {
  return (
    <main className="flex flex-col w-full min-h-screen bg-[#FAFAF9] pt-[83px]">
      
      {/* Section 1: Banner 1 */}
      <section className="relative flex flex-col items-center justify-center w-full min-h-[630px] bg-[#FAFAF9] px-4 md:px-[120px] py-[80px]">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center w-full max-w-[1280px] gap-12 md:gap-[60px]">
          ...
          <div className="flex-1 flex flex-col justify-center items-center md:items-start p-2 gap-6">
            <h2 className="font-signature text-[48px] md:text-[64px] leading-[1.1] text-[#1C1917] text-center md:text-left lowercase">
              your style deserves to shine
            </h2>
            <p className="font-poppins text-[15px] md:text-[16px] leading-[1.8] text-[#5c5650] text-center md:text-left font-light tracking-wide max-w-[500px]">
      ...
      <section className="flex flex-col items-center w-full bg-white px-4 md:px-[120px] py-[100px] border-t border-stone-100">
        <div className="w-full max-w-[1280px] flex flex-col items-center gap-16">
          ...
          <div className="flex flex-col items-center gap-4">
            <span className="font-poppins text-[12px] uppercase tracking-[0.2em] text-[#C19A5B] font-semibold">The Craftsmanship</span>
            <h2 className="font-poppins text-[28px] md:text-[36px] font-normal text-[#1C1917] text-center leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full">
            ...
            <div className="flex flex-col items-center text-center gap-4">
              <div className="w-16 h-16 rounded-full bg-stone-50 flex items-center justify-center mb-2">
                <Leaf size={28} strokeWidth={1.2} className="text-[#1C1917]" />
              </div>
              <h3 className="font-poppins text-[18px] text-[#1C1917] font-medium">Ethical Sourcing</h3>
              <p className="font-poppins text-[14px] text-stone-500 leading-relaxed font-light">
            ...
            <div className="flex flex-col items-center text-center gap-4">
              <div className="w-16 h-16 rounded-full bg-stone-50 flex items-center justify-center mb-2">
                <Scissors size={28} strokeWidth={1.2} className="text-[#1C1917]" />
              </div>
              <h3 className="font-poppins text-[18px] text-[#1C1917] font-medium">Artisan Tailoring</h3>
              <p className="font-poppins text-[14px] text-stone-500 leading-relaxed font-light">
            ...
            <div className="flex flex-col items-center text-center gap-4">
              <div className="w-16 h-16 rounded-full bg-stone-50 flex items-center justify-center mb-2">
                <BadgeCheck size={28} strokeWidth={1.2} className="text-[#1C1917]" />
              </div>
              <h3 className="font-poppins text-[18px] text-[#1C1917] font-medium">Enduring Quality</h3>
              <p className="font-poppins text-[14px] text-stone-500 leading-relaxed font-light">
      ...
      <section className="flex flex-col items-center w-full bg-[#1C1917] px-4 md:px-[120px] py-[120px]">
        <div className="w-full max-w-[800px] flex flex-col items-center text-center gap-8">
          <p className="font-inria italic text-[24px] md:text-[36px] leading-relaxed text-[#FAFAF9] font-light">
            "True luxury is the quiet confidence of wearing something made exclusively with passion and purpose."
          </p>
          <div className="w-12 h-[1px] bg-[#C19A5B] mt-4"></div>
          <span className="font-poppins text-[14px] uppercase tracking-widest text-stone-400 mt-2">Laural Clothing</span>
        </div>
      </section>
      ...
      <section className="relative flex flex-col items-center justify-center w-full min-h-[500px] bg-stone-300 px-4 md:px-[120px] py-[100px]">
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-[1040px] gap-[24px]">
          <h2 className="font-signature text-[48px] md:text-[56px] leading-tight text-[#1C1917] text-center">
            Why choose us
          </h2>
          <p className="font-poppins text-[15px] md:text-[17px] leading-[1.8] text-[#33302d] text-center max-w-[904px] font-light">
      ...
      <section className="flex flex-col items-center w-full bg-stone-100 px-4 md:px-[120px] py-[80px]">
        <div className="w-full max-w-[1280px] bg-white border border-stone-200 p-8 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex flex-col gap-4 flex-1">
            <h2 className="font-poppins text-[28px] md:text-[36px] font-normal text-[#1C1917] leading-tight">
              Experience Laural in Person
            </h2>
            <p className="font-poppins text-[15px] text-stone-500 leading-relaxed font-light max-w-[500px]">
            ...
            <div className="flex items-center gap-2 text-[#C19A5B] mt-2">
              <MapPin size={18} />
              <span className="font-poppins text-[14px] font-medium">Colombo Flagship Studio, Sri Lanka</span>
            </div>
          </div>
          ...
          <div className="flex-shrink-0">
            <Link 
              href="/contact" 
              className="flex items-center gap-3 bg-[#1C1917] hover:bg-[#33302d] transition-colors text-white px-8 py-4 font-poppins font-medium text-[14px] uppercase tracking-wide rounded-sm"
            >
