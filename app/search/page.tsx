  ...
  return (
    <main className="relative flex flex-col w-full min-h-screen bg-[#FAFAF9] pt-[83px]">
      ...
      <div className="w-full bg-[#1C1917] py-12 px-4 flex flex-col items-center justify-center text-center">
        <h1 className="font-poppins font-semibold text-[32px] text-[#FAFAF9] leading-tight mb-2">
          Search Results
        </h1>
        <p className="font-poppins text-[15px] text-[#FAFAF9]/70">
...
export default function SearchPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#FAFAF9]">Loading...</div>}>
      <SearchResults />
    </Suspense>
  );
}
