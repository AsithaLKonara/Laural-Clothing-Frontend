...
export default function AdBannerSection() {
  ...
  const activeBanner = banners?.find(b => b.active && b.type === 'PROMO');
  ...
  return (
    <section className="relative flex flex-col justify-center items-center px-4 md:px-8 lg:px-[120px] py-10 md:py-[60px] w-full h-[150px] md:h-[250px] overflow-hidden hover:opacity-95 transition-opacity">
      {activeBanner.link ? (
