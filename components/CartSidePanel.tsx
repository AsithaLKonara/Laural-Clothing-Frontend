      ...
      >
          ...
          <div className="flex-1 overflow-y-auto py-[10px] flex flex-col gap-[10px] pr-[5px]">
            {cartItems.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center h-full gap-[16px] text-stone-500">
                ...
                <p className="font-poppins font-medium text-[14px]">Your cart is currently empty.</p>
              </div>
            )}
          </div>
        </div>
        ...
        {cartItems.length > 0 && (
          <div className="flex flex-col gap-[10px] w-full flex-shrink-0">
            <div className="flex justify-between items-center py-[21px] border-t border-[#1C1917]/50 h-[66.5px]">
              <span className="font-poppins font-semibold text-[16px] leading-[24px] text-[#1C1917]">
                Subtotal :
              </span>
              <span className="font-poppins font-semibold text-[16px] leading-[24px] text-[#1C1917]">
                Rs: 4080.00
            ...
            <div className="flex flex-col gap-[10px]">
              ...
              <button className="flex justify-center items-center w-full h-[36px] bg-[#1C1917] rounded-full hover:bg-stone-800 transition-colors">
                <span className="font-inter font-bold text-[12px] leading-[15px] text-[#FAFAF9]">
                  Checkout
                </span>
              </button>
            </div>
